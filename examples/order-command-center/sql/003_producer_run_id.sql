...
CREATE INDEX IF NOT EXISTS order_event_ledger_topic_run_idx
    ON order_event_ledger ((kafka_metadata::jsonb ->> 'topic'), producer_run_id);

CREATE INDEX IF NOT EXISTS order_current_state_topic_run_idx
    ON order_current_state (kafka_topic, producer_run_id);
